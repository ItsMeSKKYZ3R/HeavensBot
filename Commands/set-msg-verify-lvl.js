...
module.exports = {
    name: "set-msg-verify-lvl",
    description: "Définissez le niveau de saction pour le mauvais langage",
            ...
            collector.once("collect", (m) => {
                ...
                if (m.content == "cancel") {
                    ...
                    if (
                        ...
                        if (!dbMsgVerify.getValue(`${message.guild.id}`)) {
                            dbMsgVerify.add(`${message.guild.id}`, res);
                        } else {
                            dbMsgVerify.set(`${message.guild.id}`, res);
                        }
                    }
                }
            });
