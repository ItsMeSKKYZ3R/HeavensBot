...
module.exports = {
    ...
    execute(bot, message, args) {
        ...
        if (!recherche)
            return message.reply("vous n'avez demandé aucune recherche.");
                ...
                .then((result) => {
                    ...
                    if (cut[0].includes("peut désigner :")) {
                        var embedL = new Discord.MessageEmbed()
                            ...
                            .setColor("RED")
                            .setFooter(
                                "résultat pour " + message.author.username
                            );
                            ...
                            wiki({
                                ...
                                .then((result) => {
                                    var msg = new Discord.MessageEmbed()
                                        ...
                                        .setFooter(
                                            `© ${bot.user.username} | Commande par Jean.#0001 ❤️`
                                        );
                                    if (
                                        result[0].includes(".png") ||
                                        result[0].includes(".jpg")
                                    ) {
                                        var image = result[0];
                                        msg.setImage(image);
                                    }
                                ...
                                .catch((error) => {
                                    var embedL = new Discord.MessageEmbed()
                                        .setTitle(
                                            "Echec de la recherche Wikipédia"
                                        )
                                        .setDescription(
